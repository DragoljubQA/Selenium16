...
public class Zadatak7 {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebDriverWait wdwait = new WebDriverWait(driver, Duration.ofSeconds(10000));
        ...
        Thread.sleep(2000);
        //wdwait.until(ExpectedConditions.visibilityOf(driver.findElement(By.className("profile-gravatar__user-display-name"))));
        ...
        Assert.assertEquals(driver.getCurrentUrl(), "https://wordpress.com/log-in?redirect_to=%2Fme");
        WebElement message = driver.findElement(By.className("login__form-header"));
